...
const packageName = "com.programming.codequiz";
...
const supportedLocales = [
    'en', 'fr', 'de', 'es', 'tr', 'ru', 'pt-PT', 'it', 'hi', 'ur', 'ar', 'am', 'eu', 'bn', 'bg', 'ca', 'hr', 'cs',
    'da', 'nl', 'et', 'fil', 'fi', 'el', 'gu', 'iw', 'hu', 'is', 'id', 'ja', 'kn', 'ko', 'lv', 'lt', 'ms', 'ml', 'mr',
    'no', 'pl', 'ro', 'sr', 'zh-CN', 'sk', 'sl', 'sw', 'sv', 'ta', 'te', 'th', 'tr', 'uk', 'vi', 'cy', 'az', 'bs',
    'ceb', 'ha', 'ig', 'jv', 'ka', 'kk', 'km', 'ku', 'ky', 'lb', 'lo', 'mg', 'mk', 'mn', 'ne', 'rw', 'sd', 'si', 'sm',
    'so', 'sq', 'st', 'su', 'ug', 'uz', 'xh', 'yi', 'yo', 'zu'
];

final languageCode = ui.window.locale.languageCode.split('-')[0];

//print(languageCode);

final defaultLanguageCode = (languageCode == 'pt')
      ? 'pt-PT'
      : (languageCode == 'zh')
          ? 'zh-CN'
          : (supportedLocales.contains(languageCode) ? languageCode : 'en');

//print(defaultLanguageCode);

//Enter 2 Letter ISO Code of country
//It will be use for phone auth.
//const initialSelectedCountryCode = 'AT';

final initialSelectedCountryCode = ui.window.locale.countryCode ?? 'AT';

//const initialCountryCode = "IN"; // change your initialCountry Code
final initialCountryCode = ui.window.locale.countryCode ?? 'AT';
...
const databaseUrl ="https://quiz.lieferex.at/quizapp";
...
const lifelines = <String, String>{
  'fiftyFifty': 'fiftyfifty_icon.svg',
  'audiencePoll': 'fiftyfifty_icon.svg',
  'skip': 'fiftyfifty_icon.svg',
  'resetTime': 'fiftyfifty_icon.svg',
};
...
const tournamentsCollection = "tournaments"; //testTournaments
...
//question or quiz time duration
// const questionDurationInSeconds = 15;
// const selfChallengeMaxMinutes = 30;
// const guessTheWordQuestionDurationInSeconds = 45;

//Math/Chemistry type of question
//It is recommended to give more time in this type of question
//because rendering time of webview will take some initial load time
// const latexQuestionDurationInSeconds = 60;
...
List<String> payoutRequestNotes(String amount, String coins) {
  return [
    "Minimum Redeemable amount is \$$amount ($coins Coins).",
...
//
const numberOfPlayerForTournament = 8;
