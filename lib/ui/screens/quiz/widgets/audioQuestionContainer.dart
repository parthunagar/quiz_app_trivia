  ...
  Widget _buildCurrentQuestionIndex() {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        color: const Color(0xfff7922d), // Color(0xfff7d35a),
                      ...
                      .map(
                        (e) => Container(
                          margin: EdgeInsets.only(
                            bottom: widget.constraints.maxHeight * 0.04,
                            left: 16, right: 16,
                            // top: widget.constraints.maxHeight * 0.04,// (0.015),
                          ),
                          ...
                          height:
                              widget.constraints.maxHeight * 0.07, // * (0.105),
