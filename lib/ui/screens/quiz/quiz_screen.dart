...
import 'package:flutterquiz/ui/widgets/customAppbarForQuiz.dart';
...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  ...
  Widget _buildShowOptionButton() {
    if (widget.quizType == QuizTypes.audioQuestions) {
      return Padding(
        padding: const EdgeInsets.only(bottom: 68.0), //ADD PADDING
        child: Align(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextCircularTimer(
                          size: 70,
                          remainingStyle: GoogleFonts.nunito(
                          ...
                          animationController: timerAnimationController,
                          arcColor: const Color(
                              0xff8cdf07), // Theme.of(context).primaryColor,
                          // color:  Theme.of(context)
                          //     .colorScheme
                          //     .onTertiary
                          //     .withOpacity(0.2),
                          color: const Color(0xff201a99),
                        ),
